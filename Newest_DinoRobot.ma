...
//Last modified: Sat, Apr 08, 2017 01:38:26 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -11.189220990107803 19.098720463460907 28.531501317892594 ;
	setAttr ".r" -type "double3" -14.73835275222927 -2178.1999999998416 4.1850634925996065e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "71F56AA0-F64F-C534-9ECC-B08A45D94329";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 36.232981758692581;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.0158496069683425 12.306807988371421 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "0B8E15E4-C449-3AB2-3C63-1B8C695A455D";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 29.212530336323585;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 8.1546642419210578 -2.8950230394743821 ;
...
createNode transform -n "pCube17";
	...
	setAttr ".r" -type "double3" 0 0 -5.4316294417109354 ;
...
createNode transform -n "pCube24";
	...
	setAttr ".r" -type "double3" 0 0 -26.985672408201395 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A0F7F7CB-6647-3A80-769A-B7B84E931B2B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "53B44B38-FB4E-1B50-2B7D-5CA8A70D3135";
createNode displayLayer -n "defaultLayer";
	rename -uid "0DD20283-514C-457B-7549-7694365BC400";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C8E5531E-BE47-B0F2-9F3F-CDBF05A2C37E";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "6FEC4A02-CE48-9BE6-72D8-C69B2B1C096E";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3DCA64C0-9D4B-D57B-EEBA-749C49EDFE70";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "291592FF-7746-5341-2EE4-1F851B1F0710";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "9A7D62BA-5342-631F-A113-E38BE3FE3233";
	setAttr ".pee" yes;
