...
//Last modified: Fri, Apr 07, 2017 03:11:16 AM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -11.771429791165897 4.0889871537216269 17.104705124333808 ;
	setAttr ".r" -type "double3" 6.2616472702359234 -1099.800000000633 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "71F56AA0-F64F-C534-9ECC-B08A45D94329";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 18.288567045296684;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -5.6133570240217505 6.0837019138967943 0 ;
...
createNode mesh -n "pCubeShape5" -p "pCube5";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.58595073223114014 0.49999994039535522 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 38 ".pt";
	setAttr ".pt[0]" -type "float3" 0 0 -0.1679602 ;
	setAttr ".pt[1]" -type "float3" 0.12959719 0.045807287 -0.1679602 ;
	setAttr ".pt[2]" -type "float3" 0.063526087 0.048449442 -0.1679602 ;
	setAttr ".pt[3]" -type "float3" -8.3266727e-016 -2.7755576e-016 -0.1679602 ;
	setAttr ".pt[36]" -type "float3" 0 0 0.1679602 ;
	setAttr ".pt[37]" -type "float3" 0.12959719 0.045807287 0.1679602 ;
	setAttr ".pt[38]" -type "float3" 0.063526087 0.048449442 0.1679602 ;
	setAttr ".pt[39]" -type "float3" -8.3266727e-016 -2.7755576e-016 0.1679602 ;
	setAttr ".pt[40]" -type "float3" 0 0 0.10135256 ;
	setAttr ".pt[41]" -type "float3" 0.12959719 0.045807287 0.10135256 ;
	setAttr ".pt[42]" -type "float3" 0.063526087 0.048449442 0.10135256 ;
	setAttr ".pt[43]" -type "float3" 0 0 0.10135256 ;
	setAttr ".pt[44]" -type "float3" 0 0 -0.10135256 ;
	setAttr ".pt[45]" -type "float3" 0.12959719 0.045807287 -0.10135256 ;
	setAttr ".pt[46]" -type "float3" 0.063526087 0.048449442 -0.10135256 ;
	setAttr ".pt[47]" -type "float3" 0 0 -0.10135256 ;
	setAttr ".pt[48]" -type "float3" 0 0 1.1175871e-008 ;
	setAttr ".pt[49]" -type "float3" 0 0 -1.1175871e-008 ;
	setAttr ".pt[52]" -type "float3" 0 0 1.1175871e-008 ;
	setAttr ".pt[53]" -type "float3" 0 0 -1.1175871e-008 ;
	setAttr ".pt[68]" -type "float3" 0 0 -0.10135254 ;
	setAttr ".pt[69]" -type "float3" 0 -2.7755576e-016 -0.16796018 ;
	setAttr ".pt[70]" -type "float3" 0 0 1.4901161e-008 ;
	setAttr ".pt[71]" -type "float3" 0 0 1.4901161e-008 ;
	setAttr ".pt[72]" -type "float3" 0 0 1.4901161e-008 ;
	setAttr ".pt[73]" -type "float3" 0 0 1.4901161e-008 ;
	setAttr ".pt[74]" -type "float3" 0 0 1.4901161e-008 ;
	setAttr ".pt[75]" -type "float3" 0 0 -1.4901161e-008 ;
	setAttr ".pt[76]" -type "float3" 0 0 -1.4901161e-008 ;
	setAttr ".pt[77]" -type "float3" 0 0 -1.4901161e-008 ;
	setAttr ".pt[78]" -type "float3" 0 0 -1.4901161e-008 ;
	setAttr ".pt[79]" -type "float3" 0 0 -1.4901161e-008 ;
	setAttr ".pt[80]" -type "float3" 0 -2.7755576e-016 0.16796018 ;
	setAttr ".pt[81]" -type "float3" 0 0 0.10135254 ;
	setAttr ".pt[82]" -type "float3" 0.054691702 -0.0087710377 -0.10135256 ;
	setAttr ".pt[83]" -type "float3" 0.054691702 -0.0087710377 -0.1679602 ;
	setAttr ".pt[94]" -type "float3" 0.054691702 -0.0087710377 0.1679602 ;
	setAttr ".pt[95]" -type "float3" 0.054691702 -0.0087710377 0.10135256 ;
...
createNode transform -n "pCube6";
	...
	setAttr ".t" -type "double3" -5.7734981690452658 6.4946807954498276 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "3CB96ACF-4386-6EBF-7AEA-2A888E7EDB81";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "21BE7D6B-40FB-0F01-2B62-49AFBA58D007";
createNode displayLayer -n "defaultLayer";
	rename -uid "0DD20283-514C-457B-7549-7694365BC400";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "12452E1A-4EF0-3D16-AACB-07AB27798243";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "6FEC4A02-CE48-9BE6-72D8-C69B2B1C096E";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "FBDF1398-4871-E796-2F50-BFB199C5FE60";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EB87148A-47A4-6593-586B-C2AA08E135A6";
...
createNode polyTweak -n "polyTweak9";
	...
	setAttr ".uopa" yes;
	setAttr -s 16 ".tk";
	setAttr ".tk[68]" -type "float3" 0 0.15938953 0 ;
	setAttr ".tk[69]" -type "float3" 0 0.15938953 0 ;
	setAttr ".tk[70]" -type "float3" 0 0.057258144 0 ;
	setAttr ".tk[71]" -type "float3" 0 0.057258144 0 ;
	setAttr ".tk[72]" -type "float3" 0.10824255 0.093904093 0 ;
	setAttr ".tk[73]" -type "float3" 0.10824255 0.093904093 0 ;
	setAttr ".tk[74]" -type "float3" 0 0.10017708 0 ;
	setAttr ".tk[75]" -type "float3" 0 0.10017708 0 ;
	setAttr ".tk[76]" -type "float3" 0 0.10017708 0 ;
	setAttr ".tk[77]" -type "float3" 0 0.10017708 0 ;
	setAttr ".tk[78]" -type "float3" 0 0.0053595635 0.095110849 ;
	setAttr ".tk[79]" -type "float3" 0 0.0053595635 -0.095110871 ;
	setAttr ".tk[80]" -type "float3" 0 -0.20644954 -0.095110871 ;
	setAttr ".tk[81]" -type "float3" 0 -0.20644954 0.095110849 ;
...
connectAttr "polySplitRing12.out" "pCubeShape5.i";
